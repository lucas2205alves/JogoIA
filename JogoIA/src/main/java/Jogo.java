...
public class Jogo {
    ...
    public void jogar(Player player1, Player player2) {
        ...
        while (terminou == false) {
            ...
            if (quemInicia == 0) {
                System.out.println("Jogador Humano: " + Arrays.toString((player1.getMao())) + " - Maior carta: " + player1.getMaiorCarta());
                ...
                System.out.println("Jogador Bot: " + Arrays.toString((player2.getMao())) + " - Maior carta: " + player2.getMaiorCarta());
                decisaoBot = 0;
